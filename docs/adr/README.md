...
| [0003](./0003-adopt-english-as-the-repository-language.md) | Adopt English as the repository language | Accepted | Observed at the v0.2.0 and v0.3.0 releases; the pilot's `init` to confirm |
| [0004](./0004-give-agents-their-own-github-identity.md) | Give agents their own GitHub identity, behind a human approval | Accepted | The pilot project, before 2026-12-31 |
