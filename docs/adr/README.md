...
| [0003](./0003-adopt-english-as-the-repository-language.md) | Adopt English as the repository language | Accepted | Observed at the v0.2.0 to v0.5.0 releases; the pilot's `init` to confirm |
