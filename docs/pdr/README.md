...
| [0006](./0006-work-where-the-forge-cannot-guard.md) | Work on a repository the forge cannot guard | Proposed (2026-09-20), implemented in v0.5.0 | 2027-03-31, on a probe repository and the pilot |
