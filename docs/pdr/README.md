...
| [0004](./0004-ask-the-right-question-to-the-right-person.md) | Ask the right question, to the right person, at the right moment | Accepted (2026-09-18), direction only | 2026-10-31, on M9's log |
| [0005](./0005-work-on-the-framework-while-using-it.md) | Work on the framework while using it, and never be judged in silence | Accepted (2026-09-18) | 2027-03-31 |
