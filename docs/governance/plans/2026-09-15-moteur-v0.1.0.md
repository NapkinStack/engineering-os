...
> M2a, M2b, M3, M3.1, M3.2 et M4 (faits), puis M6.
...
flowchart LR
    ...
    M4 --> M6["M6<br/>documentation produit"]:::encours
    M6 --> M61["M6.1<br/>fiabilité des contrôles"]:::afaire
...
- [ ] **Étape 1.** Réécrire `skeleton/docs/os/09-plateforme.md` :
...
- [ ] **Étape 2.** `02-modules.md` §7 : « Changement du socle | Fichiers du squelette : équipe
  socle, revue élargie ; module `platform/` s'il existe ».

### Tâche 2 — Contrôles annoncés, non automatisés (D15)

- [ ] **Étape 1.** Index des ADR (racine et squelette) : colonne « Contrôle » → « Revue, à
...
- [ ] **Étape 2.** Ces contrôles relèvent du moteur : lignes ajoutées au backlog
...
- [ ] **Étape 1.** `README.md` : présentation (framework de travail), état, schéma du parcours
...
- [ ] **Étape 2.** `CONTRIBUTING.md` : schéma légendé du parcours d'un chantier (chantier,
...
- [ ] **Étape 1.** Feuille de route : nœud `M6.1 — fiabilité des contrôles hérités` entre M6 et
...
- [ ] **Étape 2.** `chantiers.md` : en-têtes de C2 et C4 → « Après le projet pilote, si le
...
- [ ] Hooks, tests (dont le garde-fou D6), `nstack fitness` ; relecture croisée des termes
