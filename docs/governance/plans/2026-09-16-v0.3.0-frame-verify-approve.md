...
- [ ] **Step 6: Run them, and the wiring**
...
- [ ] `README.md` commands table: `| nstack discover <idea-file> | Starts a discovery for your agent: the idea kept, its document created |`
...
- [ ] **Step 1: See S1 fail** — create `skeleton/playbooks/discovery.md` with its title only;
...
- [ ] **Step 3: The skill's entry, the framing's start, the folder's README**
...
- [ ] **Step 4: Run the suite** — `Platform tests: OK`.
