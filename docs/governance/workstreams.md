...
flowchart LR
    ...
    V50 --> V60["v0.6.0<br/>what is announced refuses<br/>the documents say the truth"]:::todo
...
| v0.6.0 | **What is announced refuses, and the documents say what is true**: D51 to D54, and the documentary lot of the internal audit — [plan](plans/2026-09-20-v0.6.0-what-is-announced-refuses.md) | In progress (2026-09-20), before the pilot |
