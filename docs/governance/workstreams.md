...
| M10 | **Every barrier the framework announces refuses**: D29 to D33, D35, D25 and D26, and PDR-0005, through to v0.4.0, proved on `tool-library` before the pilot — [plan](plans/2026-09-19-v0.4.0-every-barrier-refuses.md) | M10a to M10g merged; the review before the tag found D36 to D43, fixed by #67 and #68; **v0.4.0 published (2026-09-19)**, tag on `486be72`, verified on published artefacts. Next: M10h on `tool-library`, then the exit decision |
