...
| D69 | **The checklist imposes a level-3 control from the first commit.** A non-author human approval before merging (`OSPS-QA-07.01`) is level 3 of 3 in the OpenSSF OSPS Baseline; G2 and G3 require it of every project from day zero. We ship the top tier as the floor. Found by the market survey behind M11, 2026-09-23 | **M11g**, opening on a probe of the mapping: clean, the project's target level decides when approval blocks (ADR-0005); not clean, it returns to M13 and the checklist applies as today |
...
| M11 | **Ceremony follows consequence** (PDR-0011): the framework charges what a failure costs, per module and per project, and states each price before it is paid; with PDR-0004's routing, and PDR-0007, PDR-0008 and PDR-0010 — through to v0.7.0 — [plan](plans/2026-09-23-m11-ceremony-follows-consequence.md) | **In progress.** Planned 2026-09-23 (#98). Merged: **M11f** (#101), **M11a** (#102), **M11b** (#103), **M11d** (#104), **M11e** (#105), **M11c** (#106), **M11h** (this record). To do: **M11g** (on its probe), **M11j** PDR-0007, **M11k** PDR-0008 and D77, **M11l** PDR-0010, **M11m** D68, D74, D75, then **M11i**, v0.7.0 |
