...
| D57 | **The kernel and PDR-0008 contradict each other on credentials.** The kernel says *"never with a human's credentials"*, without nuance; PDR-0008 says an agent may apply the forge's settings with a credential that **cannot commit**. Given exactly such a token — Administration write, `Contents: No access` — a fresh session read the kernel and refused to use it, then asked the decider. It was right to report rather than resolve, and the two texts still disagree. Found by the pilot on 2026-09-20 | **M11**, with PDR-0008: either the kernel carries the exception or `nstack setup` does |
...
| M11 | **Ceremony follows consequence** (PDR-0011): the framework charges what a failure costs, per module and per project, and states each price before it is paid; with PDR-0004's routing, and PDR-0007, PDR-0008 and PDR-0010 — through to v0.7.0 — [plan](plans/2026-09-23-m11-ceremony-follows-consequence.md) | **In progress.** Planned 2026-09-23 (#98). Merged: **M11f** (#101), **M11a** (#102), **M11b** (#103), **M11d** (#104), **M11e** (#105), **M11c** (#106), **M11h** (this record). **M11g** closed by its probe (2026-09-24, not clean: returned to M13). To do: **M11j** PDR-0007, **M11k** PDR-0008, D77 and D78, **M11l** PDR-0010, **M11m** D68, D74, D75, then **M11i**, v0.7.0 |
