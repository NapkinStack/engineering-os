...
| M10 | **Every barrier the framework announces refuses**: D29 to D33, D35, D25 and D26, and PDR-0005, through to v0.4.0, proved on `tool-library` before the pilot — [plan](plans/2026-09-19-v0.4.0-every-barrier-refuses.md) | M10a to M10g merged (2026-09-19); version 0.4.0 merged, **its tag held**: the independent review before the tag found D36 to D43 — R1 to R4 first, then the tag, M10h, the exit decision |
