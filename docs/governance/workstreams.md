...
| M9 | Team-mode validation: the pilot rehearsed on a public subject, two teams, one cycle, drift probes, before paying for GitHub Team — [plan](plans/2026-09-17-team-mode-validation.md) | In progress: Tasks 0 to 3 done (2026-09-18), the discovery decided `go`; next the framing |
| PDR-0004 | [Ask the right question, to the right person, at the right moment](../pdr/0004-ask-the-right-question-to-the-right-person.md) | Proposed (2026-09-18): the direction only — stage derived from the checks, hats in playbooks, recipient read from the project. Its design waits on M9's log; criterion checked 2026-10-31 |
