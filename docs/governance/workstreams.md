...
flowchart LR
    ...
    M10 --> V41["v0.4.1<br/>V1 proved from the base<br/>D44 to D47"]:::todo
    V41 --> PP["Pilot project<br/>private, GitHub Team"]:::todo
...
| v0.4.1 | **V1 cannot be walked around, and says what it proved**: D44 to D47 — the proof run from the base's tree, its verdict never hidden nor mis-worded, K1's message between two cycles. The pilot's precondition | To plan (2026-09-19), M10's exit decision **fix first** |
