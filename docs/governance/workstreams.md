...
flowchart LR
    ...
    V60 --> M11["M11<br/>the first gesture<br/>routing · stages · settings"]:::todo
...
| Pilot | **`NapkinStack/flet`, the first real project**, run by a session that knew nothing of this repository, with the maintainer as decider and this repository's agent as observer — public on the Free plan, where the whole checklist is available, rather than private on Team where G5 is paid and G6 does not exist | **Running since 2026-09-20**: discovery decided *go* after three rounds and two independent challenges, charter accepted, cycle 01 closed `stopped/reframed` with nothing accepted, cycle 02 in progress; 23 pull requests, every merged one reviewed, one closed rather than merged on a failed scenario, and `Commits on main` green 20 times out of 20. It has produced D56 to D61, replicated D26 and D55, and measured D49 |
...
| M11 | **The first gesture costs what it buys**: PDR-0004's routing, PDR-0007's stages, PDR-0008's settings command and PDR-0010's form, through to v0.7.0 | To plan, after two more weeks of the pilot rather than three days — its four decisions were all accepted on 2026-09-22, and three of them were found or confirmed by the pilot itself |
